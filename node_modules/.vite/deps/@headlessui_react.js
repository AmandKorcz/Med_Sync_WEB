...
function Me({ children: e8, enabled: t11 = true }) {
  ...
  let { refs: b9, floatingStyles: w11, context: g6 } = useFloating2({ open: i15, placement: a20 === "selection" ? p6 === "center" ? "bottom" : `bottom-${p6}` : p6 === "center" ? `${a20}` : `${a20}-${p6}`, strategy: "absolute", transform: false, middleware: [offset2({ mainAxis: a20 === "selection" ? 0 : E13, crossAxis: v3 }), shift2({ padding: c15 }), a20 !== "selection" && flip2({ padding: c15 }), a20 === "selection" && P7 ? inner({ ...P7, padding: c15, overflowRef: u16, offset: r18, minItemsVisible: q, referenceOverflowThreshold: c15, onFallbackChange(h8) {
    var O8, W4;
    if (!h8) return;
